...
class GetArgs(object):
    ...
    def get_args(self):
        ...
        parser.add_argument('-k2', '--key2', action='store', dest='key2', help='Second Unseal Key', type=str, required=True)
        parser.add_argument('-k3', '--key3', action='store', dest='key3', help='Third Unseal Key', type=str, required=True)
